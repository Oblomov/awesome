...
--   seconds.
-- @tparam[opt=5] integer args.margin_leftright The left/right margin for the text.
-- @tparam[opt=3] integer args.margin_topbottom The top/bottom margin for the text.
